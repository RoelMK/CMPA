...
private:
	...
	const int minimalDeltaNoiseDetect = 10;					// If difference between noise threshold and detection threshold is lower than this value, CMPA will show a warning
	...
	const int maximalNoise = 100;						// Maximal noise reading (corrupt if higher)
