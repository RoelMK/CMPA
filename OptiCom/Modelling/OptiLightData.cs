...
namespace OptiCom.Modelling
{
    public class OptiLightData
    {
        ...
        {
            //return OptiLightGenerator.MAGIC_NUMBER + ";" + VLow.ToString("0.0", System.Globalization.CultureInfo.InvariantCulture) + ";" + VHigh.ToString("0.0", System.Globalization.CultureInfo.InvariantCulture) + ";" + EstimatedFETOffTime.ToString("0.00000", System.Globalization.CultureInfo.InvariantCulture) + ";0;0";
